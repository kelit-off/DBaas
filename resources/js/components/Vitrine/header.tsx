        ...
        <header className="border-b shadow-md px-72 py-4 w-full max-w-screen">
            <nav className="flex items-center justify-between w-full">
                            ...
                            <div key={item.title}>
                                {item.children?.length ? (
                                    ...
                                    <Popover className="relative">
                                        ...
                                        <PopoverPanel className="absolute left-0 mt-2 w-[600px] bg-white dark:bg-black border rounded-xl shadow-lg p-4 flex gap-6">
                                            {/* Colonne principale */}
                ...
                <div className='flex items-center'>
                    {auth.user ? (
                        <>
                            <Link href="/dashboard" className="font-semibold mr-3">
                        ...
                        <>
                            ...
                            <Link href="/register" className="ml-4 font-semibold">
                                Start your project
                            </Link>
                        </>
                    )}
